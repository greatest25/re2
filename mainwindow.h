...
//*****************算法1 A* 处理路径规划信号的槽函数****************
    ...
    // 新增：为单个无人机规划路径
    void planPathForSingleDrone(const QString &droneId);
...
//*****************算法3 动态窗口法 (DW)****************
    DWPlanner *dwPlanner;
    void initializeDWPlanner();
    void cleanupDWPlanner();
    bool isDWPlannerInitialized;
    void onVelocityComputed(const QString &droneId, const QPointF &velocity, const QVector<double> &scores);
};
#endif // MAINWINDOW_H
